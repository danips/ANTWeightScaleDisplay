...
public class ShoulderPressExerciseName  {
    ...
    public static final int DUMBBELL_SHOULDER_PRESS = 24;
    public static final int MILITARY_PRESS = 25;
    public static final int STRICT_PRESS = 27;
    public static final int DUMBBELL_FRONT_RAISE = 28;
    public static final int DUMBBELL_CURL_TO_OVERHEAD_PRESS_WHEELCHAIR = 29;
    public static final int ARNOLD_PRESS_WHEELCHAIR = 30;
    public static final int OVERHEAD_DUMBBELL_PRESS_WHEELCHAIR = 31;
    ...
    static {
        ...
        stringMap.put(DUMBBELL_CURL_TO_OVERHEAD_PRESS_WHEELCHAIR, "DUMBBELL_CURL_TO_OVERHEAD_PRESS_WHEELCHAIR");
