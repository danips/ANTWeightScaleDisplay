...
public class PlyoExerciseName  {
    ...
    public static final int BOX_JUMP = 33;
    public static final int BOX_JUMP_OVERS = 34;
    public static final int BOX_JUMP_OVERS_OVER_THE_BOX = 35;
    public static final int STAR_JUMP_SQUATS = 36;
    public static final int JUMP_SQUAT = 37;
