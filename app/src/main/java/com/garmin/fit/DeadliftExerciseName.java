...
public class DeadliftExerciseName  {
    ...
    public static final int KETTLEBELL_DEADLIFT = 20;
    public static final int KETTLEBELL_SUMO_DEADLIFT = 21;
    public static final int ROMANIAN_DEADLIFT = 23;
    public static final int SINGLE_LEG_ROMANIAN_DEADLIFT_CIRCUIT = 24;
    public static final int STRAIGHT_LEG_DEADLIFT = 25;
