...
public class LateralRaiseExerciseName  {
    ...
    public static final int DUMBBELL_LATERAL_RAISE = 34;
    public static final int RING_DIP_KIPPING = 36;
    public static final int WALL_WALK = 37;
    public static final int DUMBBELL_FRONT_RAISE_WHEELCHAIR = 38;
    public static final int DUMBBELL_LATERAL_RAISE_WHEELCHAIR = 39;
    public static final int POLE_DOUBLE_ARM_OVERHEAD_AND_FORWARD_WHEELCHAIR = 40;
    public static final int POLE_STRAIGHT_ARM_OVERHEAD_WHEELCHAIR = 41;
    ...
    static {
        ...
        stringMap.put(POLE_DOUBLE_ARM_OVERHEAD_AND_FORWARD_WHEELCHAIR, "POLE_DOUBLE_ARM_OVERHEAD_AND_FORWARD_WHEELCHAIR");
        stringMap.put(POLE_STRAIGHT_ARM_OVERHEAD_WHEELCHAIR, "POLE_STRAIGHT_ARM_OVERHEAD_WHEELCHAIR");
    }
