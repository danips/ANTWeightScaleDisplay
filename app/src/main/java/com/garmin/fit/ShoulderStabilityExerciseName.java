...
public class ShoulderStabilityExerciseName  {
    ...
    public static final int CABLE_INTERNAL_ROTATION = 33;
    public static final int LYING_INTERNAL_ROTATION = 34;
    public static final int SEATED_DUMBBELL_INTERNAL_ROTATION = 35;
