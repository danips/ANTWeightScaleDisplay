...
public abstract class FieldBase {
      ...
      switch (getType()) {
         ...
         case Fit.BASE_TYPE_STRING:
            for (Object value : values) {
               size += value.toString().getBytes().length + 1;
            }
            break;
   ...
   public boolean isValid(int index) {
      ...
      if (value instanceof Number) {
         return !Fit.baseTypeInvalidMap.get(type).equals(value);
      }
               ...
               for (int i=0; i<size; i++)
               {
                  ...
                  if (b == 0) {
                     if (buffer.size() > 0) {
                        ...
                        values.add(new String(buffer.toByteArray()));
                     } else {
                        emptyStrings++;
                     }
      ...
      try {
         ...
         if (value == null) {
            ...
            switch (getType()) {
               ...
               case Fit.BASE_TYPE_STRING: {
                  OutputStreamWriter stringWriter = new OutputStreamWriter(out);
