...
public class FileUtil {
   ...
   static public Collection<byte[]> split(InputStream input) {
      Collection<byte[]> files = new ArrayList<>();
   ...
   static public Collection<byte[]> prepend(Collection<byte[]> files, File fromFileType,
         File toFileType) {
      Collection<byte[]> fromFiles = new ArrayList<>();
      Collection<byte[]> toFiles = new ArrayList<>();
      Collection<byte[]> returnFiles = new ArrayList<>();
