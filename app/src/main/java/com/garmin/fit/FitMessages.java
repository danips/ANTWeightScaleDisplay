...
public class FitMessages {
    ...
    final List<SleepDisruptionSeverityPeriodMesg> sleepDisruptionSeverityPeriodMesgs = new ArrayList<>();
    final List<SleepDisruptionOvernightSeverityMesg> sleepDisruptionOvernightSeverityMesgs = new ArrayList<>();
    ...
    public List<SleepDisruptionSeverityPeriodMesg> getSleepDisruptionSeverityPeriodMesgs() {
        return Collections.unmodifiableList(sleepDisruptionSeverityPeriodMesgs);
    }

    public List<SleepDisruptionOvernightSeverityMesg> getSleepDisruptionOvernightSeverityMesgs() {
