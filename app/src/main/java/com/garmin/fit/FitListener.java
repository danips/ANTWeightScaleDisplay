    ...
    public void onMesg(Mesg mesg) {
        switch (mesg.getNum()) {
            ...
            case MesgNum.TRAINING_SETTINGS:
                fitMessages.trainingSettingsMesgs.add(new TrainingSettingsMesg(mesg));
                break;
            ...
            case MesgNum.SLEEP_DISRUPTION_SEVERITY_PERIOD:
                fitMessages.sleepDisruptionSeverityPeriodMesgs.add(new SleepDisruptionSeverityPeriodMesg(mesg));
                break;
            case MesgNum.SLEEP_DISRUPTION_OVERNIGHT_SEVERITY:
                fitMessages.sleepDisruptionOvernightSeverityMesgs.add(new SleepDisruptionOvernightSeverityMesg(mesg));
                break;
