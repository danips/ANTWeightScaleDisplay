...
public class MesgBroadcaster implements MesgListener, MesgDefinitionListener {
   ...
   public MesgBroadcaster(Decode decode) {
      ...
      mesgListeners = new ArrayList<>();
      mesgDefinitionListeners = new ArrayList<>();
      fileIdMesgListeners = new ArrayList<>();
      fileCreatorMesgListeners = new ArrayList<>();
      timestampCorrelationMesgListeners = new ArrayList<>();
      softwareMesgListeners = new ArrayList<>();
      slaveDeviceMesgListeners = new ArrayList<>();
      capabilitiesMesgListeners = new ArrayList<>();
      fileCapabilitiesMesgListeners = new ArrayList<>();
      mesgCapabilitiesMesgListeners = new ArrayList<>();
      fieldCapabilitiesMesgListeners = new ArrayList<>();
      deviceSettingsMesgListeners = new ArrayList<>();
      userProfileMesgListeners = new ArrayList<>();
      hrmProfileMesgListeners = new ArrayList<>();
      sdmProfileMesgListeners = new ArrayList<>();
      bikeProfileMesgListeners = new ArrayList<>();
      connectivityMesgListeners = new ArrayList<>();
      watchfaceSettingsMesgListeners = new ArrayList<>();
      ohrSettingsMesgListeners = new ArrayList<>();
      zonesTargetMesgListeners = new ArrayList<>();
      sportMesgListeners = new ArrayList<>();
      hrZoneMesgListeners = new ArrayList<>();
      speedZoneMesgListeners = new ArrayList<>();
      cadenceZoneMesgListeners = new ArrayList<>();
      powerZoneMesgListeners = new ArrayList<>();
      metZoneMesgListeners = new ArrayList<>();
      goalMesgListeners = new ArrayList<>();
      activityMesgListeners = new ArrayList<>();
      sessionMesgListeners = new ArrayList<>();
      lapMesgListeners = new ArrayList<>();
      lengthMesgListeners = new ArrayList<>();
      recordMesgListeners = new ArrayList<>();
      eventMesgListeners = new ArrayList<>();
      deviceInfoMesgListeners = new ArrayList<>();
      trainingFileMesgListeners = new ArrayList<>();
      hrvMesgListeners = new ArrayList<>();
      weatherConditionsMesgListeners = new ArrayList<>();
      weatherAlertMesgListeners = new ArrayList<>();
      gpsMetadataMesgListeners = new ArrayList<>();
      cameraEventMesgListeners = new ArrayList<>();
      gyroscopeDataMesgListeners = new ArrayList<>();
      accelerometerDataMesgListeners = new ArrayList<>();
      magnetometerDataMesgListeners = new ArrayList<>();
      threeDSensorCalibrationMesgListeners = new ArrayList<>();
      videoFrameMesgListeners = new ArrayList<>();
      obdiiDataMesgListeners = new ArrayList<>();
      nmeaSentenceMesgListeners = new ArrayList<>();
      aviationAttitudeMesgListeners = new ArrayList<>();
      videoMesgListeners = new ArrayList<>();
      videoTitleMesgListeners = new ArrayList<>();
      videoDescriptionMesgListeners = new ArrayList<>();
      videoClipMesgListeners = new ArrayList<>();
      courseMesgListeners = new ArrayList<>();
      coursePointMesgListeners = new ArrayList<>();
      segmentIdMesgListeners = new ArrayList<>();
      segmentLeaderboardEntryMesgListeners = new ArrayList<>();
      segmentPointMesgListeners = new ArrayList<>();
      segmentLapMesgListeners = new ArrayList<>();
      segmentFileMesgListeners = new ArrayList<>();
      workoutMesgListeners = new ArrayList<>();
      workoutSessionMesgListeners = new ArrayList<>();
      workoutStepMesgListeners = new ArrayList<>();
      scheduleMesgListeners = new ArrayList<>();
      totalsMesgListeners = new ArrayList<>();
      weightScaleMesgListeners = new ArrayList<>();
      bloodPressureMesgListeners = new ArrayList<>();
      monitoringInfoMesgListeners = new ArrayList<>();
      monitoringMesgListeners = new ArrayList<>();
      hrMesgListeners = new ArrayList<>();
      memoGlobMesgListeners = new ArrayList<>();
      antChannelIdMesgListeners = new ArrayList<>();
      antRxMesgListeners = new ArrayList<>();
      antTxMesgListeners = new ArrayList<>();
      exdScreenConfigurationMesgListeners = new ArrayList<>();
      exdDataFieldConfigurationMesgListeners = new ArrayList<>();
      exdDataConceptConfigurationMesgListeners = new ArrayList<>();
      fieldDescriptionMesgListeners = new ArrayList<>();
      developerDataIdMesgListeners = new ArrayList<>();
      padMesgListeners = new ArrayList<>();
   }
