...
public class ShrugExerciseName  {
    ...
    public static final int WIDE_GRIP_BARBELL_SHRUG = 17;
    public static final int BEHIND_THE_BACK_SHRUG = 18;
    public static final int DUMBBELL_SHRUG_WHEELCHAIR = 19;
    public static final int SHRUG_WHEELCHAIR = 20;
    public static final int SHRUG_ARM_DOWN_WHEELCHAIR = 21;
    public static final int SHRUG_ARM_MID_WHEELCHAIR = 22;
    public static final int SHRUG_ARM_UP_WHEELCHAIR = 23;
    public static final int UPRIGHT_ROW = 24;
