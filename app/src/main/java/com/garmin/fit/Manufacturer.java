...
public class Manufacturer  {
    ...
    public static final int LUHONG_TECHNOLOGY = 153;
    ...
    public static final int TEKTRO_RACING_PRODUCTS = 333;
    public static final int DARAD_INNOVATION_CORPORATION = 334;
    public static final int CYCLOPTIM = 335;
    public static final int RUNNA = 337;
