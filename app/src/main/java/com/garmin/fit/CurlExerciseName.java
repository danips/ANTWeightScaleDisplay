...
public class CurlExerciseName  {
    ...
    public static final int ONE_ARM_CONCENTRATION_CURL = 44;
    public static final int STANDING_ZOTTMAN_BICEPS_CURL = 45;
    public static final int DUMBBELL_BICEPS_CURL = 46;
    public static final int DRAG_CURL_WHEELCHAIR = 47;
    public static final int DUMBBELL_BICEPS_CURL_WHEELCHAIR = 48;
    public static final int BOTTLE_CURL = 49;
    public static final int SEATED_BOTTLE_CURL = 50;
