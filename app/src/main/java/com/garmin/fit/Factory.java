...
public class Factory {
    static public Mesg createMesg(Mesg mesg) {
        ...
        case MesgNum.SLEEP_DISRUPTION_SEVERITY_PERIOD:
            return new SleepDisruptionSeverityPeriodMesg(mesg);
        case MesgNum.SLEEP_DISRUPTION_OVERNIGHT_SEVERITY:
            return new SleepDisruptionOvernightSeverityMesg(mesg);
    ...
    private static final Mesg mesgs[] = new Mesg[123];
    ...
    static {
        ...
        mesg_index++;
        mesgs[mesg_index] = TrainingSettingsMesg.trainingSettingsMesg;
        mesg_index++;
        ...
        mesg_index++;
        mesgs[mesg_index] = SleepDisruptionSeverityPeriodMesg.sleepDisruptionSeverityPeriodMesg;
        mesg_index++;
        mesgs[mesg_index] = SleepDisruptionOvernightSeverityMesg.sleepDisruptionOvernightSeverityMesg;
        mesg_index++;
