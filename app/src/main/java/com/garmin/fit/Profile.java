...
public class Profile {
    ...
    public static String enumValueName(Profile.Type enumType, long enumVal) {
        ...
        case MOVE_EXERCISE_NAME:
            retVal = MoveExerciseName.getStringFromValue((int)enumVal);
            break;

        case POSE_EXERCISE_NAME:
            retVal = PoseExerciseName.getStringFromValue((int)enumVal);
            break;
        ...
        case BIKE_EXERCISE_NAME:
            retVal = BikeExerciseName.getStringFromValue((int)enumVal);
            break;

        case BANDED_EXERCISES_EXERCISE_NAME:
            retVal = BandedExercisesExerciseName.getStringFromValue((int)enumVal);
            break;

        case BATTLE_ROPE_EXERCISE_NAME:
            retVal = BattleRopeExerciseName.getStringFromValue((int)enumVal);
            break;

        case ELLIPTICAL_EXERCISE_NAME:
            retVal = EllipticalExerciseName.getStringFromValue((int)enumVal);
            break;

        case FLOOR_CLIMB_EXERCISE_NAME:
            retVal = FloorClimbExerciseName.getStringFromValue((int)enumVal);
            break;

        case INDOOR_BIKE_EXERCISE_NAME:
            retVal = IndoorBikeExerciseName.getStringFromValue((int)enumVal);
            break;

        case INDOOR_ROW_EXERCISE_NAME:
            retVal = IndoorRowExerciseName.getStringFromValue((int)enumVal);
            break;

        case LADDER_EXERCISE_NAME:
            retVal = LadderExerciseName.getStringFromValue((int)enumVal);
            break;

        case SANDBAG_EXERCISE_NAME:
            retVal = SandbagExerciseName.getStringFromValue((int)enumVal);
            break;

        case SLED_EXERCISE_NAME:
            retVal = SledExerciseName.getStringFromValue((int)enumVal);
            break;

        case SLEDGE_HAMMER_EXERCISE_NAME:
            retVal = SledgeHammerExerciseName.getStringFromValue((int)enumVal);
            break;

        case STAIR_STEPPER_EXERCISE_NAME:
            retVal = StairStepperExerciseName.getStringFromValue((int)enumVal);
            break;

        case SUSPENSION_EXERCISE_NAME:
            retVal = SuspensionExerciseName.getStringFromValue((int)enumVal);
            break;

        case TIRE_EXERCISE_NAME:
            retVal = TireExerciseName.getStringFromValue((int)enumVal);
            break;

        case BIKE_OUTDOOR_EXERCISE_NAME:
            retVal = BikeOutdoorExerciseName.getStringFromValue((int)enumVal);
            break;

        case RUN_INDOOR_EXERCISE_NAME:
            retVal = RunIndoorExerciseName.getStringFromValue((int)enumVal);
            break;
        ...
        case SLEEP_DISRUPTION_SEVERITY:
            retVal = SleepDisruptionSeverity.getStringFromValue(SleepDisruptionSeverity.getByValue(shortVal));
            break;
