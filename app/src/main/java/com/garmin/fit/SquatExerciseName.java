...
public class SquatExerciseName  {
    ...
    public static final int ALTERNATING_BOX_DUMBBELL_STEP_UPS = 92;
    public static final int DUMBBELL_OVERHEAD_SQUAT_SINGLE_ARM = 93;
    public static final int DUMBBELL_SQUAT_SNATCH = 94;
    public static final int MEDICINE_BALL_SQUAT = 95;
    public static final int WALL_BALL_SQUAT_AND_PRESS = 97;
    public static final int SQUAT_AMERICAN_SWING = 98;
    public static final int AIR_SQUAT = 100;
    public static final int DUMBBELL_THRUSTERS = 101;
    public static final int OVERHEAD_BARBELL_SQUAT = 102;
