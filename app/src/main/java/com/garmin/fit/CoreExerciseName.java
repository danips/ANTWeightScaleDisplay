...
public class CoreExerciseName  {
    ...
    public static final int BICEP_CURL_WITH_LEG_EXTENSION_WITH_WEIGHTS = 73;
    public static final int HANGING_L_SIT = 75;
    public static final int LOWER_LIFT_WITH_WEIGHTS = 77;
    public static final int RING_L_SIT = 79;
    public static final int ROWING_1_WITH_WEIGHTS = 80;
    public static final int ROWING_2_WITH_WEIGHTS = 81;
    public static final int SCISSORS_WITH_WEIGHTS = 82;
    public static final int SINGLE_LEG_STRETCH_WITH_WEIGHTS = 83;
    public static final int TOES_TO_ELBOWS = 84;
    public static final int WEIGHTED_CRISS_CROSS = 85;
    public static final int WEIGHTED_DOUBLE_LEG_STRETCH = 86;
    public static final int WEIGHTED_THE_HUNDRED = 87;
    public static final int L_SIT = 88;
    public static final int TURKISH_GET_UP = 89;
    public static final int WEIGHTED_RING_L_SIT = 90;
    public static final int WEIGHTED_HANGING_L_SIT = 91;
    public static final int WEIGHTED_L_SIT = 92;
    public static final int SIDE_BEND_LOW_WHEELCHAIR = 93;
    public static final int SIDE_BEND_MID_WHEELCHAIR = 94;
    public static final int SIDE_BEND_HIGH_WHEELCHAIR = 95;
    public static final int SEATED_SIDE_BEND = 96;
    ...
    static {
        ...
        stringMap.put(BICEP_CURL_WITH_LEG_EXTENSION_WITH_WEIGHTS, "BICEP_CURL_WITH_LEG_EXTENSION_WITH_WEIGHTS");
