...
public class LungeExerciseName  {
    ...
    public static final int ALTERNATING_DUMBBELL_LUNGE = 81;
    public static final int DUMBBELL_REVERSE_LUNGE = 82;
    public static final int OVERHEAD_DUMBBELL_LUNGE = 83;
    public static final int SCISSOR_POWER_SWITCH = 84;
    public static final int DUMBBELL_OVERHEAD_WALKING_LUNGE = 85;
    public static final int CURTSY_LUNGE = 86;
    public static final int WEIGHTED_CURTSY_LUNGE = 87;
    public static final int WEIGHTED_SHIFTING_SIDE_LUNGE = 88;
    public static final int WEIGHTED_SIDE_LUNGE_AND_PRESS = 89;
    public static final int WEIGHTED_SIDE_LUNGE_JUMP_OFF = 90;
